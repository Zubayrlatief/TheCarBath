    ...
    <section class="service-section executive-detail">
      <div class="container">
        <div class="section-header">
          <span class="section-eyebrow">Premium Service</span>
          <h2>Executive Detail</h2>
          <p class="section-subtitle">Our flagship service delivering showroom-level perfection inside and out.</p>
        </div>
        ...
        <div class="service-content">
          ...
          <div class="service-info">
            <div class="service-features">
              ...
              <div class="features-grid">
                <div class="feature-card">
                  <div class="feature-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                      <path d="M3 12h18l-1.5-1.5M3 12l1.5-1.5M3 12v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6"/>
                      <path d="M8 12h8"/>
                    </svg>
                  </div>
                  <div class="feature-content">
                    <h4>Ceramic-Safe Hand Wash</h4>
                    <p>Gentle, premium products that protect your ceramic coating</p>
                  </div>
                </div>
                <div class="feature-card">
                  <div class="feature-icon">
                  ...
                  <div class="feature-content">
                    <h4>Machine Polish</h4>
                    <p>Professional polishing to restore paint depth and shine</p>
                  </div>
                </div>
                <div class="feature-card">
                  <div class="feature-icon">
                  ...
                  <div class="feature-content">
                    <h4>Full Interior Reset</h4>
                    <p>Complete interior cleaning and conditioning</p>
                  </div>
                </div>
                <div class="feature-card">
                  <div class="feature-icon">
                  ...
                  <div class="feature-content">
                    <h4>Protection Treatment</h4>
                    <p>Wax or sealant application for lasting protection</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="service-benefits">
              <h3>Why Choose Executive Detail?</h3>
              <ul class="benefits-list">
                <li>Perfect for special occasions and events</li>
                <li>Maintains ceramic coating integrity</li>
                <li>Professional-grade equipment and products</li>
                <li>Comprehensive interior and exterior care</li>
              </ul>
            </div>
            ...
            <div class="service-cta">
              <RouterLink to="/bookings" class="btn btn-primary">
                ...
                Book Executive Detail
              </RouterLink>
              <span class="cta-note">Same day booking available</span>
            </div>
          </div>
        </div>
      </div>
